 ...
 * Plugin URI: http://www.bigmarketing.co.uk/
 * Description: Scores Ticker for the Leaderboard
 * Version: 1.0.0
 * Author: Andrew Hosegood
 * Author URI: http://www.bigmarketing.co.uk/
 * License: GPL2
 */
...
function ach_ticker_style() {
	wp_enqueue_style('ach_news_ticker_css', plugins_url() . '/css/ticker.css');
}
add_action('wp_enqueue_style', 'ach_ticker_style');
...
<div class="ticker">
<h3>
    <span style="display:block; font-size:75%; margin-bottom:1rem;">
    <?php
